...
class ImageNetwork():
    ...
    def process_image(self, img, select_threshold=0.5):
        """
...
if __name__=="__main__":
    with ImageNetwork() as network:
        ...
        rclasses, rscores, rbboxes = network.process_image(img, select_threshold=0.8)
        ...
        for name in image_names:
            if name.endswith("jpg"):
                ...
                mpimg.imsave(output_path, img, format='jpg')
